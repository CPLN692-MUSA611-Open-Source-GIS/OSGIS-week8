...
/* 
$.ajax('https://data.sfgov.org/resource/wv5m-vpq2.geojson').done(function(json) {
    data = json.features
    buildSlide(slides[currentSlide])
})
Call */
$.ajax('https://data.sfgov.org/resource/i28k-bkz6.geojson').done(function(json) {
    data = json.features
    buildSlide(slides[currentSlide])
})

$.getJSON('stanford-sp464ds6332-geojson.json').done(function(json) {
    data = json.features
    buildSlide(slides[currentSlide])
})
